...
const { OWNER_NUMBER, PREFIX, PUPPETEER_EXECUTABLE_PATH } = require('./config');
...
const client = new Client({
  ...
  puppeteer: {
    headless: true,
    executablePath: PUPPETEER_EXECUTABLE_PATH || undefined, // Railway pe system chromium use hoga
    args: [
      '--no-sandbox',
